...
const Home = () => {
  return (
    ...
    <section className="hero__section pt-[30px] 2xl:h-[700px]">
        ...
        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
          ...
          <div>
            <div className="lg:w-[570px]">
              ...
              <p className="text__para">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolore laborum corrupti delectus sapiente! Reprehenderit delectus architecto sunt illo quisquam in magni. laborum.</p>
    ...
    <section>
      <div className="conatiner">
        <div className="xl:w-[470px] mx-auto">
          <h2 className="heading text-cneter">Our medical services</h2>
          <p className="text__para text-center">
        ...
        <div className="flex items-center justify-between flex-col lg:flex-row">
          ...
          <div className="xl:w-[670px]">
            ...
            <ul className="pl-4">
              ...
              <li className="text__para">
                3. View our physician who are accepting new patients, use the online 
